...
func (c *userClient) GetByID(ctx context.Context, in *dto.UserGetByIDRequest, opts ...grpc.CallOption) (*dto.UserGetByIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(dto.UserGetByIDResponse)
...
func (UnimplementedUserServer) GetByID(context.Context, *dto.UserGetByIDRequest) (*dto.UserGetByIDResponse, error) {
...
func _User_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetByID(ctx, req.(*dto.UserGetByIDRequest))
	}
